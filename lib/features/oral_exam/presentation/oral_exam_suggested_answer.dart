...
class OralExamSuggestedAnswer extends StatefulWidget {
  ...
  @override
  State<OralExamSuggestedAnswer> createState() =>
      _OralExamSuggestedAnswerState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Suggested Answer :",
              style: TextFontStyle.textStyle16w700primaryColor,
            ),
            ...
            Row(
              children: [
                Expanded(
                    child: CustomAnswerButton(
                  buttonName: "Answered  Wrong ❌",
