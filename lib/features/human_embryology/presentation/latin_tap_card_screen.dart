...
class LatinTapCardScreen extends StatefulWidget {
  @override
  _LatinTapCardScreenState createState() => _LatinTapCardScreenState();
}

class _LatinTapCardScreenState extends State<LatinTapCardScreen> {
